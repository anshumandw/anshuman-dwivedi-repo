...
package com.QeatsFile.qeats.services;
...
import com.QeatsFile.qeats.repositoryservices.RestaurantRepositoryService;
...
public class RestaurantServiceMockitoTestStub {
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    allRestaurantsCloseByOffPeakHours = restaurantService
            .findAllRestaurantsCloseBy(new GetRestaurantsRequest(20, 30.2), LocalTime.of(3,0));
